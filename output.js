...
(function(exports) {
  ...
  var project = function (v) {
      return function (v1) {
          var y_rotate_angle = (v.y * $$Math.cos(v1.qz) - v.x * $$Math.sin(v1.qz)) * $$Math.cos(v1.qx) + v.z * $$Math.sin(v1.qx);
          var z_rotate_angle = v.z * $$Math.cos(v1.qx) - y_rotate_angle * $$Math.sin(v1.qx);
          var x_rotate_angle = (v.x * $$Math.cos(v1.qz) + v.y * $$Math.sin(v1.qz)) * $$Math.cos(v1.qy) + z_rotate_angle * $$Math.sin(v1.qy);
          return {
              x: 250.0 + x_rotate_angle, 
              y: 250.0 + y_rotate_angle
          };
      };
  };
      ...
      return function (state1) {
          return function (draw) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Main line 97, column 3 - line 102, column 25: " + [ v.constructor.name ]);
              };
          };
      };
  };
  var drawBackground = function (ctx) {
      return function __do() {
          var v = Graphics_Canvas.setFillStyle("rgb(0, 0, 0)")(ctx)();
      ...
      return withAnimateContext("mycanvas")(state)(function (ctx) {
          return function (state1) {
              return function __do() {
                  ...
                  $99.y = state1.y;
                  $99.z = state1.z;
                  $99.qx = state1.qx + state1.loop;
                  $99.qy = state1.qy;
                  $99.qz = state1.qz;
                  $99.loop = Data_Ord.max(Data_Ord.ordNumber)(state1.loop - 1.0e-2)(0.0);
                  return $99;
              };
          };
      });
  })();
  var startcube_yaxis = (function () {
      var canvas = Graphics_Canvas.getCanvasElementById("mycanvas");
      return withAnimateContext("mycanvas")(state)(function (ctx) {
          return function (state1) {
              return function __do() {
                  ...
                  $103.qz = state1.qz;
                  $103.loop = Data_Ord.max(Data_Ord.ordNumber)(state1.loop - 1.0e-2)(0.0);
                  return $103;
              };
          };
      });
  })();
  var startcube_zaxis = (function () {
      var canvas = Graphics_Canvas.getCanvasElementById("mycanvas");
      return withAnimateContext("mycanvas")(state)(function (ctx) {
          return function (state1) {
              return function __do() {
                  ...
                  $107.qx = state1.qx;
                  $107.qy = state1.qy;
                  $107.qz = state1.qz + state1.loop;
                  $107.loop = Data_Ord.max(Data_Ord.ordNumber)(state1.loop - 1.0e-2)(0.0);
                  return $107;
              };
          };
      });
      ...
      return withAnimateContext("mycanvas")(state)(function (ctx) {
          return function (state1) {
              return function __do() {
                  ...
                  $111.y = state1.y;
                  $111.z = state1.z;
                  $111.qx = state1.qx - state1.loop;
                  $111.qy = state1.qy - state1.loop;
                  $111.qz = state1.qz - state1.loop;
                  $111.loop = Data_Ord.max(Data_Ord.ordNumber)(state1.loop - 1.0e-2)(0.0);
                  return $111;
              };
          };
      });
              ...
              return function __do() {
                  ...
                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(v4)(Control_Monad_Eff_DOM.addEventListener("mousemove")(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                      ...
                      if ($127) {
                          ...
                          return startcube_zaxis();
                      };
                      return Control_Monad_Eff_Console.log("")();
                  })))();
              };
          };
          throw new Error("Failed pattern match at Main line 164, column 3 - line 164, column 57: " + [ v2.constructor.name ]);
      })())();
  });
  ...
  exports["startcube_xaxis"] = startcube_xaxis;
  exports["startcube_yaxis"] = startcube_yaxis;
  exports["startcube_zaxis"] = startcube_zaxis;
  exports["state"] = state;
